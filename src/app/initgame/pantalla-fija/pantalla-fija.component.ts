...
@Component({
  selector: 'app-pantalla-fija',
  templateUrl: './pantalla-fija.component.html',
  styleUrls: ['./pantalla-fija.component.css'],
})
export class PantallaFijaComponent implements OnInit, OnDestroy {
  idsCat;
  initialDataToGame;
  btnGInit;
  btnReset;
